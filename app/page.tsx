...
export default function MastermindTutoringWebsite() {
  ...
  const packages = [
    ...
    },
    {
      ...
      label: "per session",
      tier: "Most Popular",
      color: "from-cyan-900/50 to-slate-800/50",
      accent: "#22d3ee",
    ...
    },
    {
      ...
      features: [
        ...
        "Exam-focused strategy sessions",
      ],
    },
  ];
  ...
  const reviews = [
    ...
    },
    {
      ...
      quote:
        "Structured sessions, professional tutors, and real improvement before tests. Worth every rand.",
      rating: 5,
    },
    {
      ...
      quote:
        "Professional, focused, and effective. Exactly what I needed going into exams.",
      rating: 5,
    },
  ];
    ...
    <div className="min-h-screen text-white" style={{ background: "#060d1a", fontFamily: "'Georgia', serif" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", height: "68px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <div style={{
              ...
              fontSize: "0.85rem", fontWeight: "700", color: "#060d1a",
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden", paddingTop: "68px" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "6rem 1.5rem", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
            <a href={bookingFormLink} target="_blank" rel="noreferrer" className="btn-primary">
              Book a Session →
            </a>
            <a href={tutorApplicationLink} target="_blank" rel="noreferrer" className="btn-ghost">
              Apply as a Tutor
            </a>
          </div>
      ...
      <section id="packages" style={{ maxWidth: "1200px", margin: "0 auto", padding: "6rem 1.5rem" }}>
        ...
        <p className="font-body" style={{ color: "#64748b", marginBottom: "3rem", maxWidth: "500px" }}>
          Pricing is based on module difficulty, year of study, and session format. Online sessions are generally at the lower end of each range.
        </p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem" }}>
          {packages.map((pkg, i) => (
            <div key={pkg.name} className={i === 1 ? "card-featured" : "card"} style={{ padding: "2rem" }}>
              ...
              <h3 className="font-display" style={{ fontSize: "1.5rem", fontWeight: "700", color: "#f1f5f9", marginTop: "1rem", marginBottom: "0.25rem" }}>
                {pkg.name}
              </h3>
              <div style={{ display: "flex", alignItems: "baseline", gap: "0.4rem", marginBottom: "1rem" }}>
                <span className="font-display" style={{ fontSize: "1.75rem", fontWeight: "700", color: i === 1 ? "#22d3ee" : "#94a3b8" }}>
                  {pkg.price}
                </span>
                <span className="font-body" style={{ fontSize: "0.8rem", color: "#475569" }}>{pkg.label}</span>
              </div>

              <p className="font-body" style={{ fontSize: "0.875rem", color: "#64748b", lineHeight: "1.65", marginBottom: "1.5rem", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "1rem" }}>
                {pkg.ideal}
              </p>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "0.75rem" }}>
              <div style={{
                ...
                borderRadius: "7px",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: "0.75rem", fontWeight: "700", color: "#060d1a",
                fontFamily: "'DM Sans', sans-serif",
              }}>M</div>
